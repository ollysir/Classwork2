...
MongoClient.connect('mongodb+srv://Ugochukwu:password1234@cluster0-vzw0q.mongodb.net/test?retryWrites=true&w=majority', function(err, db) {
  if(!err) {
  p = db
...
const dbo2 = p.db("Classw2"); //database
